...
class ContentCategoryUpdateRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('backend_edit_contentcategories');
    }
    ...
    {
        return [
            'name' => 'required|unique:content_categories,name,'.$this->get('id'),
            'title' => 'required|unique:content_categories,title,'.$this->get('id'),
            'subtitle' => 'nullable',
            'tags' => 'nullable',
