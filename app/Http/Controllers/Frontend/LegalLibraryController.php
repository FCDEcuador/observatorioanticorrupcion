...
/**
* Clase para seccion de biblioteca legal
* @Autor Raúl Chauvin
...
class LegalLibraryController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $data = [
            ...
            'legalLibraryList' => LegalLibrary::searchLegalLibraries($request->sTags, $request->iIssueYear, 6),
    	];

    	$view = view('frontend.legal-library', $data);
