...
class ProvincesController extends Controller
{
    ...
    public function destroy(Request $request, $sId = '')
    {
        ...
        if($oProvince->delete()){
            ...
            return response()->json(['status' => false , 'message' => 'El meta tag '.$oProvince->description.' no pudo ser eliminada. Por favor intentelo nuevamente luego de unos minutos.',], 200);
        }
    }
}
