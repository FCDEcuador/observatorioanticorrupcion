...
class AuthFrontendPermissionsCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'permission:frontend-permissions {name} {--R|remove}';
     ...
     * @var string
     */
    protected $description = 'Administración de permisos para el frontend del sistema (establecimientos).';
