...
$(document).ready(function() {
    ...
    $('#summary').wysihtml5();
    $('#history').wysihtml5();
    $('#legal_causes').wysihtml5();
    $('#political_causes').wysihtml5();
    $('#economic_consequences').wysihtml5();
    $('#social_consequences').wysihtml5();
    $('#sources').wysihtml5();
