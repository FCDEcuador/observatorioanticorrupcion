...
<div class="container">
	...
	<div class="row mt-3 no-gutters">
		<div class="col-sm-6">
			<div class="bgceleste text-white p-3 antecedentes">
		...
		<div class="col-sm-6">
			<img class="d-block w-100 h-100" src="https://picsum.photos/560/300?auto=yes&bg=666&fg=444&text=1" alt="Publicacion1">
		</div>
	</div>
	...
	<div class="row">
        <div class="col-md-12">
        	<div class="fz40 morado text-center"><i class="far fa-calendar-alt"></i></div>
	...
	<div class="row mt-3 mb-3">
		<div class="col-sm-6">
			<h1 class="titulo border-bottom border-default text-default text-uppercase">¿Por QUé ocurrió?</h1>
		</div>
	</div>
	...
	<div class="row mt-5">
		<div class="col-sm-6" >
			<div class="p-3" style="background: rgba(36,57,91,0.7);">
				<h2 class=" border-bottom border-white text-white text-uppercase font-weight-bold">Concecuencias</h2>
				<div class="subtitulo text-white font-italic mt-3">Económica</div>
				<div class="detalle text-white">
	...
	<div class="row" style="background: url('https://picsum.photos/1000/260?auto=yes&bg=666&fg=444&text=social') no-repeat;background-size: cover;">
		<div class="col-sm-6" >
			<div class="p-3" style="background: rgba(36,57,91,0.7);">
			...
			<div class="col-sm-6">
				<div class="row no-gutters">
					...
					<div class="col-8 pl-3 pl-sm-0 pr-3 pr-sm-0">
						...
						<p><a href="" class="text-secondary">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque convallis dolor ac nibh sollicitudin faucibus. Fusce venenatis odio non condimentum pulvinar. Donec facilisis enim gravida lectus pretium egestas. </a></p>
					</div>
				</div>
			</div>
			<div class="col-sm-6">
