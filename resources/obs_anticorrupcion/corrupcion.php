...
<div class="container-fluid p-3 bg-light">
		...
		<div class="col-sm-6 d-flex align-items-end justify-content-center" style="background:rgba(0,178,226,0.4);">
			<div class="row">
				<div class="offset-sm-4 col-sm-8">
					<h3 class="subtitulo text-white text-uppercase text-right fz32">Pellentesque convallis dolor ac nibh sollicitudin faucibus</h3>
				</div>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-12 d-flex align-items-middle justify-content-center mt-3">
			<div class="text-muted text-center mr-3">
		      <i class="fas fa-eye"></i> 102
		    </div>
		    <div class="text-muted text-center mr-1 d-none d-sm-inline-block">Compartir:</div>
			<div class="share-md mr-3">
				<div class="addthis_inline_share_toolbox d-flex justify-content-center"></div>
			</div>
			<div><a href="" role="button" class="btn btn-success btn-sm float-right">descarga PDF</a></div>
		</div>
	</div>
</div>
...
<div class="container">
	...
	<div class="row mt-3 no-gutters">
		...
		<div class="col-sm-6">
			<img class="d-block w-100 h-100" src="https://via.placeholder.com/600x280" alt="Publicacion1">
		</div>
	</div>
	...
	<div class="row">
        <div class="col-md-12 ml-2">
        	<div class="fz40 morado text-left text-sm-center calendario-time-line"><i class="far fa-calendar-alt"></i></div>
            <div class="main-timeline">
                        ...
                        <div class="description">
                            <div class="scrollbar scrollbar-secondary">
							  <div class="force-overflow text-justify pr-2">
								Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate ducimus officiis Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate ducimus officiis Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate ducimus officiis Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate ducimus officiis Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate ducimus officiis Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate ducimus officiis Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate ducimus officiis Lorem ipsum dolor sit amet, consectetur adipisicin. Cupiditate ducimus officiis Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate ducimus officiis Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate ducimus officiis Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate ducimus officiis Lorem ipsum dolor sit amet, consectetur adipisicin. Cupiditate ducimus officiis Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate ducimus officiis Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate ducimus officiis Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate ducimus officiis Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate ducimus officiis Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate ducimus officiis Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate ducimus officiis   	
							  </div>
							</div>
                ...
                <div class="timeline">
                    <div class="timeline-content">
                        <h3 class="title">12 Octubre 2018</h3>
                        <div class="description">
	                        <div class="scrollbar scrollbar-secondary">
							    <div class="force-overflow text-justify pr-2">
	...
	<div class="row mt-5">
		<div class="col-sm-6" >
			<div class="p-3" style="background: rgba(36,57,91,0.7);">
				<h2 class=" border-bottom border-white text-white text-uppercase font-weight-bold">Consecuencias</h2>
				<div class="subtitulo text-white font-italic mt-3">Económica</div>
		...
		<div class="col-sm-6">
			<div class="p-3">
				<div class="subtitulo text-secondary font-italic text-right">Nihil anim keffiyeh helvetica, craft beer labore wes anderson</div>
				<div class="fz50 font-italic morado font-weight-bold text-right">8'890 millones de dolares</div>
				<small class="text-secondary"> aute, non cupidatat skateboard</small>
			</div>
		</div>
	</div>
	<div class="row" style="background: url('https://via.placeholder.com/1000x260') no-repeat;background-size: cover;">
		<div class="col-sm-6" >
			<div class="p-3" style="background: rgba(36,57,91,0.7);">
				<div class="subtitulo text-white font-italic mt-3">Social</div>
				<div class="detalle text-white text-justify">
		...
		<div class="col-sm-6 d-flex align-items-end justify-content-end mb-3 mt-3 mt-sm-0">
			<a href="" role="button" class="btn btn-success btn-sm">descarga PDF</a>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-6" >
			...
			<div class="col-sm-6">
				<div class="row no-gutters">
					...
					<div class="col-8 pl-3 pl-sm-0 pr-3 pr-sm-0">
						<h6 class="text-success font-weight-bold">Loren ipsun dolor didiad,madmafa</h6>
						<h3 class="subtitulo text-default text-uppercase"><a href="#" class="text-default">Pellentesque convallis dolor ac nibh</a></h3>
						<p class="text-justify"><a href="" class="text-secondary">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque convallis dolor ac nibh sollicitudin faucibus. Fusce venenatis odio non condimentum pulvinar. Donec facilisis enim gravida lectus pretium egestas. </a></p>
					</div>
				</div>
			</div>
			<div class="col-sm-6">
