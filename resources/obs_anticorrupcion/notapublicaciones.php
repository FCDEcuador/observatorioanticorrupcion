...
<div class="container mt-3">
	<div class="row mt-3">
		<div class="col-sm-6">
			<div class="titulo border-bottom border-success ext-success text-uppercase">Publicaciones</div>
		</div>
	</div>
	...
	<!-- BEGIN SECCION CONTENIDDO -->
		<div class="col-sm-8">
			<div class="shadow p-3 mb-5 bg-white rounded">
				<img src="https://picsum.photos/750/350" alt="asasf" title="asfsaf" class=" w-100">
				<div class="row mt-1">
				    <div class="col align-self-start text-muted">
				      16 de Enero de 2000
				    </div>
				    <div class="col align-self-end text-muted text-right">
				      <i class="fas fa-eye"></i> 102
				    </div>
			  	</div>
			  	<div class="content mt-3">
				  	<h6 class="text-success">Loren ipsun dolor didiad,madmafa</h6>
					<h3 class="titulo text-info text-uppercase">NUEVOS CASOS DE CORRUPCIÓN</h3>
	...
	<!-- BEGIN SECCION LATERAL -->
		<div class="col-sm-4">
			...
			<div class="shadow p-3 mb-5 bg-white rounded">
				...
				<div class="elemento">
					<img src="https://picsum.photos/750/350" alt="sdgdsg" title="dsgdsg" class="w-100 mt-2">
					<h5 class="mt-3"><a href="" class="azul">Lorem ipsum dolor sit amet, consectetur adipiscing elit. </a></h5>
					<div class="row mt-1">
					    <div class="col align-self-start text-muted">
					      16 de Enero de 2000
					    </div>
			...
			<!-- END lo mas reciente -->
			<div class="compartir shadow p-3 mb-5 bg-white rounded">
