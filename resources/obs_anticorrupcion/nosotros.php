...
<div class="container mt-3">
	...
	<!-- BEGIN SECCION MISION -->
		<div class="row mt-3 p-3 bg-light">
			...
			<div class="row mt-3">
				<div class="col-sm-6">
					<iframe class="w-100 h-100" src="https://www.youtube.com/embed/bcIc4YC0nEg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
	...
	<div class="row mt-3 p-3 ">
		<div class="col-12">
			<h3 class="text-secondary text-center">Con el apoyo de:</h3>
		</div>
		<div class="col-12">
			<div class="row mt-3 mb-1">
				<div class="col-sm-6 align-self-center mt-3 pl-5 pr-5 pl-sm-0 pr-sm-0">
					<a href="https://www.padf.org/" target="_blank"><img src="images/padf.png" class="mx-auto d-block img-fluid"></a>
				</div>
				<div class="col-sm-6 align-self-center mt-5 mt-sm-3  pl-5 pr-5 pl-sm-0 pr-sm-0">
					<a href="http://www.oas.org/es/" target="_blank"><img src="images/OEA.png" class="mx-auto d-block img-fluid"></a>
				</div>
			</div>
		</div>
	</div>
