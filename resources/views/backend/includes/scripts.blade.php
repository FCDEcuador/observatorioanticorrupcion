    ...
    <!--Wave Effects -->
    {!! Html::script('backend/assets/js/waves.min.js', ['type' => 'text/javascript']) !!}
    <!--Menu sidebar -->
    {!! Html::script('backend/assets/js/sidebarmenu.min.js', ['type' => 'text/javascript']) !!}
    <!--stickey kit -->
    {!! Html::script('backend/assets/plugins/sticky-kit-master/dist/sticky-kit.min.js', ['type' => 'text/javascript']) !!}
    {!! Html::script('backend/assets/plugins/sparkline/jquery.sparkline.min.js', ['type' => 'text/javascript']) !!}
