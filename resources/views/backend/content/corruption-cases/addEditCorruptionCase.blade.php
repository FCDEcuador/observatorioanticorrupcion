                                            ...
                                            @foreach($aWhatHappendLines as $oWhatHappened)
                                                ...
                                                <div class="row" id="whatHappenedDiv_{!! $nextWH !!}">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <textarea name="description[]" id="description_{!! $nextWH !!}" class="form-control description_val" rows="4">{!! $oWhatHappened->description !!}</textarea>
                                                    </div>
                                                    <div class="col-md-1">
...
@section('custom-js')
    ...
    {!! Html::script('backend/assets/js/form-validate/form-validation-corruption-case.min.js', ['type' => 'text/javascript']) !!}
